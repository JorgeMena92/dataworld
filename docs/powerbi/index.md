---
title: Power BI
description: Power BI notes, patterns, and reference guides
---

# Power BI

Practical Power BI notes organized by topic — from data modeling to DAX patterns and report development best practices, built from real project experience.
...
<div class="card-grid">
  ...
  <a href="power-query/" class="card">
    <div class="card__title">Power Query</div>

...
The six core clauses every SQL query is built on. Learn these well and you can answer most business questions with data.
...
This query reads as: *"For active employees, group by department, keep only departments with more than 3 people, and show them sorted by total salary."*

---

!!! tip
    Master these six clauses before moving on to JOINs, CTEs, or window functions. Every advanced SQL pattern builds on top of this foundation.